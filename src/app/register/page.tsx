      ...
      <div className="relative hidden md:flex flex-col justify-between bg-zinc-950 p-12 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-6xl font-black text-white leading-[1.1] tracking-tight">
            Stop arguing <br />
            over who paid <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-rose-400">for dinner.</span>
          </h1>
          <p className="mt-8 text-xl text-zinc-400 font-medium max-w-md">
            Create an account to track shared expenses, calculate exact balances, and settle debts instantly.
          </p>
        </div>
      ...
      <div className="flex items-center justify-center p-8 md:p-12 relative">
        ...
        <div className="w-full max-w-[420px] space-y-10">
          <div className="space-y-3">
            <h2 className="text-4xl font-black text-zinc-900 tracking-tight">Create an account</h2>
            <p className="text-lg text-zinc-500 font-medium">Join SplitSmarter to start managing expenses.</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <Button 
              type="submit"
              className="w-full h-14 text-lg rounded-2xl font-bold bg-indigo-600 hover:bg-indigo-700 text-white shadow-[0_8px_30px_rgb(79,70,229,0.3)] transition-all active:scale-[0.98] mt-6"
